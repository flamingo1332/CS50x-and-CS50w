    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Categories', ''), ('Electronics', 'electronics'), ('Fashion', 'fashion'), ('Furniture', 'furniture'), ('Food', 'food'), ('Toys & Hobby', 'toys & hobby'), ('Other', 'other')], default='', max_length=30)),
